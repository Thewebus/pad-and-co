...
class GVAElement_Icon_Box_Group extends GVAElement_Base{
	...
	*/
	public function get_title() {
		return __('GVA Icon Box Group', 'zilom-themer');
	}
	 ...
	 protected function register_controls() {
		  ...
		  $repeater->add_control(
			 ...
			 [
				...
				'placeholder' => __( 'Active', 'zilom-themer' ),
				'default' => 'no'
			 ]
		  );
		  ...
		  $this->add_control(
			 ...
			 [
				...
				'default'     => array(
				  array(
					 'title'  => esc_html__( 'Learn Skills', 'zilom-themer' ),
				  ),
				  array(
					 'title'       => esc_html__( 'Expert Teachers', 'zilom-themer' ),
				  ),
				  array(
					 'title'  => esc_html__( 'Certificates', 'zilom-themer' ),
				  )
				)
			 ]
		  );
